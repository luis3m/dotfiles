;;; vscode-dark.el --- A complete port of the default Visual Studio Code Dark+ theme for Emacs
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-9-face          ((,class :foreground ,fg1)))
