...
values."
  (setq-default
   ...
   dotspacemacs-themes '(vscode-dark
                         nord
                         spacemacs-dark
                         spacemacs-light)
...
you should place your code here."
  ...
  (use-package lsp-mode
    :ensure t
    :commands lsp
    :hook (elm-mode . lsp) (scala-mode . lsp) (lsp-mode . lsp-lens-mode)
    :config
